...
namespace e_shop_api.Migrations
{
    ...
    [Migration("20221004130536_Alter Order V2")]
    partial class AlterOrderV2
    {
            ...
            modelBuilder.Entity("e_shop_api.DataBase.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Account = "Clark",
                            CreationTime = new DateTime(2022, 10, 4, 21, 5, 36, 363, DateTimeKind.Local).AddTicks(2186),
                            LastModificationTime = new DateTime(2022, 10, 4, 21, 5, 36, 364, DateTimeKind.Local).AddTicks(3297),
