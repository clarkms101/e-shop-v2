...
namespace e_shop_api.Migrations
{
    ...
    [Migration("20221005070216_Alter Order V3")]
    partial class AlterOrderV3
    {
            ...
            modelBuilder.Entity("e_shop_api.DataBase.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Account = "Clark",
                            CreationTime = new DateTime(2022, 10, 5, 15, 2, 16, 473, DateTimeKind.Local).AddTicks(6189),
                            LastModificationTime = new DateTime(2022, 10, 5, 15, 2, 16, 474, DateTimeKind.Local).AddTicks(8053),
